		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktexfraexfragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktexfraexfragment-display": {
								"semanticObject": "comsapktexfraexfragment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.exfra.exfragment",
									"url": sap.ui.require.toUrl("com/sap/kt/exfra/exfragment")
								}
							}
						}
					}
